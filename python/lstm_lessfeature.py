...
EPOCHS = 300
LEARNING_RATE = 8e-4
model = SAKTModel(df_offline_train.shape[1]-3, 10, 1, embed_dim=64, pos_encode='LSTM',
                  max_seq=None, nlayers=2, rnnlayers=2,
...
torch.save(model.state_dict(), "test_lstm_less_less.pth")